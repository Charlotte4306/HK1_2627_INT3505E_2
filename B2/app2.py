...
BOOKS = [
    ...
    {"id":2, "title":"RESTful Web APIs", "author":"L. Richardson"},
    {"id":3, "title":"API Design Patterns", "author":"JJ Geewax"},
    {"id":4, "title":"RESTful API Design", "author":"Matthias Biehl"}
]
...
def put(bid):
    i = next((
            k for k,
            b in enumerate(BOOKS) if b["id"]==bid
            ),
        None)
    if i is None:
        return jsonify(error="not found"), 404
